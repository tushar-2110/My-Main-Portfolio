        ...
        items-center h-full px-4 md:flex-row">
            ...
            <div className="flex flex-col justify-center h-full">
                 ...
                 <p className="text-gray-500 py-4 max-w-md">
                    With a deep understanding of cutting-edge technologies and a knack for 
                    problem-solving, I bring creativity, dedication, and a drive for continuous
                    learning to every  coding endeavor.
                 </p>
